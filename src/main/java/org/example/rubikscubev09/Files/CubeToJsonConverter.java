...
public class CubeToJsonConverter {
    /**
     * Writes a Graph object to a JSON file.
     *
     * @param cube    The Graph object to be converted to JSON.
     * @param filePath The path to the file where the JSON will be saved.
     */
    public static void writeCubeToJson(Cube cube, String filePath) {
     ...
     */
    public static Cube readGCubeFromJson(String filePath) {
